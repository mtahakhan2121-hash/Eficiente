export type PortfolioItem = {
  ...
  visualTone: string;
  logoSymbol: string;
  filterCategories: PortfolioFilterCategory[];
  imageSrc?: string;
};
...
export const portfolioFilterOptions: PortfolioFilterCategory[] = [
  "All",
  "Infrastructure",
  "Mobility",
  "Deep Tech",
...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    logoSymbol: "✺",
    filterCategories: ["Infrastructure", "Mobility"],
    imageSrc: "/assets/Elements & Icons/mobility.png"
  },
  {
    slug: "oneedershot",
    name: "OneederShot",
  ...
  },
  {
    ...
    logoSymbol: "◉",
    filterCategories: ["Infrastructure", "Deep Tech"]
  },
  {
    slug: "rest-easier",
    name: "Rest Easier",
  ...
  },
  {
    ...
    logoSymbol: "◑",
    filterCategories: ["Deep Tech"]
  },
  {
    slug: "permia-sensing",
    name: "Permia Sensing",
    category: "Industrial Sensing",
    tag: "Industrial Sensing",
    description:
  ...
  },
  {
    ...
    logoSymbol: "◈",
    filterCategories: ["Energy", "Deep Tech"]
  }
];
